...
namespace ewm {
    ...
    public static partial class Texts {
        ...
        public static class Forms {
            public static class Membership {
                ...
                public static class ResetPassword {
                    public static LocalText EmailSubject = "Reset Your ewm Password";
                ...
                public static class SignUp {
                    public static LocalText ActivateEmailSubject = "Activate Your ewm Account";
                    ...
                    public static LocalText FormTitle = "Sign up for ewm";
        ...
        public static class Navigation {
            ...
            public static LocalText SiteTitle = "ewm";
        }
