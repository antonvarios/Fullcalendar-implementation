...
(function (ewm) {
    ...
    })(Membership = ewm.Membership || (ewm.Membership = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Membership;
...
(function (ewm) {
    var Members;
    (function (Members) {
        var MembersDialog = (function (_super) {
            __extends(MembersDialog, _super);
            function MembersDialog() {
                _super.apply(this, arguments);
                this.form = new Members.MembersForm(this.idPrefix);
            }
            MembersDialog.prototype.getFormKey = function () { return Members.MembersForm.formKey; };
            MembersDialog.prototype.getIdProperty = function () { return Members.MembersRow.idProperty; };
            MembersDialog.prototype.getLocalTextPrefix = function () { return Members.MembersRow.localTextPrefix; };
            MembersDialog.prototype.getNameProperty = function () { return Members.MembersRow.nameProperty; };
            MembersDialog.prototype.getService = function () { return Members.MembersService.baseUrl; };
            MembersDialog.prototype.dialogOpen = function () {
                _super.prototype.dialogOpen.call(this);
                this.element.closest(".ui-dialog").find(".ui-icon-maximize-window").click();
            };
            MembersDialog = __decorate([
                Serenity.Decorators.registerClass(),
        ...
        Members.MembersDialog = MembersDialog;
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Common;
...
(function (ewm) {
    var Members;
    (function (Members) {
        var MembersEditor = (function (_super) {
            __extends(MembersEditor, _super);
            function MembersEditor(container) {
                _super.call(this, container);
            }
            MembersEditor.prototype.getColumnsKey = function () { return 'Members.Members'; };
            MembersEditor.prototype.getDialogType = function () { return Members.MembersEditorDialog; };
            MembersEditor.prototype.getLocalTextPrefix = function () { return Members.MembersRow.localTextPrefix; };
            MembersEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], MembersEditor);
            return MembersEditor;
        }(ewm.Common.GridEditorBase));
        Members.MembersEditor = MembersEditor;
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
...
(function (ewm) {
    var Members;
    (function (Members) {
        var MembersEditorDialog = (function (_super) {
            __extends(MembersEditorDialog, _super);
            function MembersEditorDialog() {
                _super.apply(this, arguments);
                this.form = new Members.MembersForm(this.idPrefix);
            }
            MembersEditorDialog.prototype.getFormKey = function () { return Members.MembersForm.formKey; };
            MembersEditorDialog.prototype.getLocalTextPrefix = function () { return Members.MembersRow.localTextPrefix; };
            MembersEditorDialog.prototype.getNameProperty = function () { return Members.MembersRow.nameProperty; };
            MembersEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MembersEditorDialog);
            return MembersEditorDialog;
        }(ewm.Common.GridEditorDialog));
        Members.MembersEditorDialog = MembersEditorDialog;
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Members;
    (function (Members) {
        var MembersGrid = (function (_super) {
            __extends(MembersGrid, _super);
            function MembersGrid(container) {
                _super.call(this, container);
            }
            MembersGrid.prototype.getColumnsKey = function () { return 'Members.Members'; };
            MembersGrid.prototype.getDialogType = function () { return Members.MembersDialog; };
            MembersGrid.prototype.getIdProperty = function () { return Members.MembersRow.idProperty; };
            MembersGrid.prototype.getLocalTextPrefix = function () { return Members.MembersRow.localTextPrefix; };
            MembersGrid.prototype.getService = function () { return Members.MembersService.baseUrl; };
            MembersGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], MembersGrid);
            return MembersGrid;
        }(Serenity.EntityGrid));
        Members.MembersGrid = MembersGrid;
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('ewm');
    })(ScriptInitialization = ewm.ScriptInitialization || (ewm.ScriptInitialization = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Common;
...
(function (ewm) {
    ...
    })(Administration = ewm.Administration || (ewm.Administration = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Administration;
...
(function (ewm) {
    var Members;
    (function (Members) {
        var MembersForm = (function (_super) {
            __extends(MembersForm, _super);
            function MembersForm() {
                _super.apply(this, arguments);
            }
            MembersForm.formKey = 'Members.Members';
            return MembersForm;
        }(Serenity.PrefixedContext));
        Members.MembersForm = MembersForm;
        [['PhoneNumber', function () { return Serenity.StringEditor; }], ['Username', function () { return Serenity.StringEditor; }], ['FirstName', function () { return Serenity.StringEditor; }], ['LastName', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(MembersForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    ...
    (function (Members) {
        var MembersRow;
        (function (MembersRow) {
            MembersRow.idProperty = 'Id';
            MembersRow.nameProperty = 'PhoneNumber';
            MembersRow.localTextPrefix = 'Members.Members';
            var Fields;
            (function (Fields) {
            })(Fields = MembersRow.Fields || (MembersRow.Fields = {}));
            ['Id', 'PhoneNumber', 'Username', 'FirstName', 'LastName'].forEach(function (x) { return Fields[x] = x; });
        })(MembersRow = Members.MembersRow || (Members.MembersRow = {}));
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    ...
    (function (Members) {
        ...
        (function (MembersService) {
            MembersService.baseUrl = 'Members/Members';
            var Methods;
            (function (Methods) {
            })(Methods = MembersService.Methods || (MembersService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                MembersService[x] = function (r, s, o) { return Q.serviceRequest(MembersService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = MembersService.baseUrl + '/' + x;
            });
        })(MembersService = Members.MembersService || (Members.MembersService = {}));
    })(Members = ewm.Members || (ewm.Members = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
...
(function (ewm) {
    ...
    ewm.BasicProgressDialog = BasicProgressDialog;
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new ewm.BasicProgressDialog();
...
(function (ewm) {
    ...
    })(DialogUtils = ewm.DialogUtils || (ewm.DialogUtils = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Common;
...
(function (ewm) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = ewm.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = ewm.LanguageList || (ewm.LanguageList = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Common;
...
(function (ewm) {
    ...
    (function (Modules) {
        var AdminLTE;
        (function (AdminLTE) {
            var CreateNewCalendarEvent = (function (_super) {
                __extends(CreateNewCalendarEvent, _super);
                function CreateNewCalendarEvent() {
                    var _this = this;
                    _super.call(this);
                    this.form = new UserForm(this.idPrefix);
                ...
                CreateNewCalendarEvent.prototype.getFormKey = function () { return UserForm.formKey; };
                CreateNewCalendarEvent.prototype.getIdProperty = function () { return UserRow.idProperty; };
                CreateNewCalendarEvent.prototype.getIsActiveProperty = function () { return UserRow.isActiveProperty; };
                CreateNewCalendarEvent.prototype.getLocalTextPrefix = function () { return UserRow.localTextPrefix; };
                CreateNewCalendarEvent.prototype.getNameProperty = function () { return UserRow.nameProperty; };
                CreateNewCalendarEvent.prototype.getService = function () { return UserService.baseUrl; };
                CreateNewCalendarEvent.prototype.getToolbarButtons = function () {
                    var _this = this;
                ...
                CreateNewCalendarEvent.prototype.updateInterface = function () {
                    _super.prototype.updateInterface.call(this);
                    this.toolbar.findButton('edit-roles-button').toggleClass('disabled', this.isNewOrDeleted());
                    this.toolbar.findButton("edit-permissions-button").toggleClass("disabled", this.isNewOrDeleted());
                };
                CreateNewCalendarEvent.prototype.afterLoadEntity = function () {
                ...
                CreateNewCalendarEvent = __decorate([
                    Serenity.Decorators.registerClass()
                ], CreateNewCalendarEvent);
                return CreateNewCalendarEvent;
            }(Serenity.EntityDialog));
            AdminLTE.CreateNewCalendarEvent = CreateNewCalendarEvent;
        })(AdminLTE = Modules.AdminLTE || (Modules.AdminLTE = {}));
    })(Modules = ewm.Modules || (ewm.Modules = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Administration;
...
(function (ewm) {
    ...
    })(Authorization = ewm.Authorization || (ewm.Authorization = {}));
})(ewm || (ewm = {}));
var ewm;
(function (ewm) {
    var Administration;
...
//# sourceMappingURL=ewm.Web.js.map