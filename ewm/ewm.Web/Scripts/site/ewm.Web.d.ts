declare namespace ewm.Administration {
...
declare namespace ewm.Authorization {
...
declare namespace ewm.Administration {
    class CreateNewCalendarEvent extends Serenity.EntityDialog<UserRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getIsActiveProperty(): string;
        protected getLocalTextPrefix(): string;
...
declare namespace ewm.ScriptInitialization {
}
declare namespace ewm {
...
declare namespace ewm.DialogUtils {
...
declare namespace ewm.LanguageList {
...
declare namespace ewm.Common.Pages {
...
declare namespace ewm.Membership {
...
declare namespace ewm.Northwind {
}
declare namespace ewm {
